...
# 3rd Open Call for Short-Term Scientific Missions (STSMs) 2026
   
We are pleased to announce the next call for STSM grant applications for the PalaeOpen COST Action for the year 2026.  
...
::: {.callout-red}
### Timeline
* **April 21th 2026**: application period ends
* **April 30th 2026**: Notification of results
...
* Financial support for combined accommodation and meals should not exceed the country-specific limits of maximum daily allowances (see [here](https://www.cost.eu/uploads/2026/03/2026-COST-Daily-Allowance-table.pdf)). Please consider inexpensive arrival and departure options.
...
For more information, please contact the Grant Awarding Coordinators: [Sandra Olivia Camara-Brugger](/coregroup.qmd#dr-sandra-olivia-camara-brugger) (sandra.bruegger(at)unibas.ch) and [Walter Finsinger](/coregroup.qmd#dr-walter-finsinger) (walter.finsinger(at)umontpellier) 
...
3. Applicants are strongly encouraged to contact the respective Working Group(s) leader(s) prior to submitting their application to ensure that the expected outcome of their STSM agrees with the objectives of this action.  
